            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs">
                        <a href="{{ route('report.tahunan') }}" class="btn btn-round text-white ml-auto fw-bold" style="background-color: #404285">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <form method="POST" action="{{ route('report.tahunan') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group @error('DateR') has-error has-feedback @enderror">
                                            <label for="DateR">Tahun</label>
                                            <select class="form-control" id="DateR" name="DateR" required>
                                                <option value="" disabled selected>Pilih Tahun</option>
                                                @for ($year = now()->year; $year >= 2020; $year--)
                                                    <option value="{{ $year }}" {{ old('DateR', $tanggalDipilih ?? '') == $year ? 'selected' : '' }}>
                                                        {{ $year }}
                                                    </option>
                                                @endfor
                                            </select>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col col-stats ml-3 ml-sm-0">
                                        <div class="numbers">
                                            <p class="card-category">Total Pengeluaran ({{ $tanggalDipilih }})</p>
                        ...
                        <div class="card card-stats card-round">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col col-stats ml-3 ml-sm-0">
                                        <div class="numbers">
                                            <p class="card-category">Total Pemasukan ({{ $tanggalDipilih }})</p>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Grafik Pengeluaran 5 Tahun Sebelumnya</div>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Grafik Pemasukan 5 Tahun Sebelumnya</div>
                            </div>
                            <div class="card-body">
                                <div class="chart-container">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Grafik Saldo 5 Tahun Sebelumnya</div>
                            </div>
                            <div class="card-body">
                                <div class="chart-container">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <div class="card-title">Laporan Tahun {{ $tanggalDipilih }}</div>
